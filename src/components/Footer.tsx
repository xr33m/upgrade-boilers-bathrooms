        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="space-y-3">
              <a href={`tel:${BUSINESS_INFO.phone}`} className="flex items-start gap-3 hover:text-blue-400 transition">
              ...
              <a href={`mailto:${BUSINESS_INFO.email}`} className="flex items-start gap-3 hover:text-blue-400 transition">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div>Sat: 9am - 5pm</div>
                  <div className="text-blue-400 font-semibold">24/7 Emergency Service</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-400">Service Areas</h3>
            <p className="mb-3">We proudly serve:</p>
            <ul className="space-y-1">
              {BUSINESS_INFO.serviceAreas.map(area => (
                <li key={area} className="text-slate-300">{area}</li>
              ))}
            </ul>
            <div className="mt-6">
              <img
