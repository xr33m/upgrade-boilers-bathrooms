        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="text-xl font-bold text-slate-900 mb-3 flex items-center gap-2">
                  <span className="bg-primary text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">6</span>
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="text-xl font-bold text-slate-900 mb-3 flex items-center gap-2">
                  <span className="bg-primary text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">7</span>
            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="bg-primary-50 border border-purple-200 p-6 rounded-lg">
                <h3 className="font-bold text-lg mb-2 text-primary-900">The 2-Month Renewal Rule</h3>
