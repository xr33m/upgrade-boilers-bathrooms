          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              ...
              <div className="bg-purple-50 border border-purple-200 p-6 rounded-lg">
                ...
                <h3 className="text-xl font-bold mb-2 text-purple-900">Save Money</h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-green-50 border-2 border-green-500 rounded-lg p-6 text-center relative">
                ...
                <div className="text-4xl font-bold text-green-600 mb-4">£12/mo</div>
                <p className="text-slate-600 mb-4">Annual service plus priority emergency cover</p>
                <Link to="/boilers/service-plans" className="text-green-600 font-semibold hover:underline">View plans →</Link>
              </div>
              <div className="bg-white border-2 border-slate-200 rounded-lg p-6 text-center">
                <h3 className="text-xl font-bold mb-2">Landlord Pack</h3>
                <div className="text-4xl font-bold text-purple-600 mb-4">£65</div>
                <p className="text-slate-600 mb-4">Service + CP12 Gas Safety Certificate</p>
                <Link to="/landlords" className="text-purple-600 font-semibold hover:underline">Learn more →</Link>
              </div>
            </div>
          </div>
        </div>
