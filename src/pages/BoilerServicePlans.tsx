        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            <div className="bg-white border-2 border-slate-200 rounded-xl p-8 hover:shadow-xl transition">
              ...
              <Link to="/contact" className="block text-center bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition">
                Choose Basic
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-white border-2 border-green-500 rounded-xl p-8 hover:shadow-xl transition relative">
              ...
              <Link to="/contact" className="block text-center bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-semibold transition">
                Choose Complete
              </Link>
            </div>
            ...
            <div className="bg-white border-2 border-slate-200 rounded-xl p-8 hover:shadow-xl transition">
              ...
              <div className="flex items-baseline gap-2 mb-6">
                <span className="text-5xl font-bold text-purple-600">£28</span>
                <span className="text-slate-600">/month</span>
              </div>
              ...
              <Link to="/contact" className="block text-center bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg font-semibold transition">
                Choose Premium
              </Link>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              ...
              <div className="bg-slate-50 p-6 rounded-lg">
                <CheckCircle2 className="w-12 h-12 text-orange-600 mb-3" />
