        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-slate-50 p-6 rounded-lg border-2 border-slate-200 hover:border-orange-500 transition">
                <Thermometer className="w-12 h-12 text-secondary mb-4" />
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Link to="/heating/gas-fire-repairs" className="group bg-gradient-to-br from-slate-50 to-white p-8 rounded-xl shadow-lg hover:shadow-xl transition border-2 border-slate-200 hover:border-orange-500">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-accent-600 transition">
                    <Flame className="w-8 h-8 text-accent group-hover:text-white transition" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-2 group-hover:text-accent transition">Gas Fire Repairs & Servicing</h3>
              ...
              <Link to="/heating/radiator-repairs" className="group bg-gradient-to-br from-slate-50 to-white p-8 rounded-xl shadow-lg hover:shadow-xl transition border-2 border-slate-200 hover:border-secondary">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-16 h-16 bg-primary-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-primary transition">
                    <Wind className="w-8 h-8 text-primary group-hover:text-white transition" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition">Radiator Repairs & Installation</h3>
              ...
              <Link to="/heating/air-source-heat-pumps" className="group bg-gradient-to-br from-slate-50 to-white p-8 rounded-xl shadow-lg hover:shadow-xl transition border-2 border-slate-200 hover:border-green-500">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-secondary transition">
                    <Zap className="w-8 h-8 text-secondary group-hover:text-white transition" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-2 group-hover:text-secondary transition">Air Source Heat Pumps</h3>
