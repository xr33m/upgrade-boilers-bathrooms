...
export default function Water2FilterInstallation() {
  return (
    <>
      ...
      <FAQSection
        faqs={waterFilterFaqs}
        title="Water2 Filter Installation Glasgow – FAQs"
        description="Common questions about Water2 under-sink water filter installation and maintenance in Glasgow."
      />
